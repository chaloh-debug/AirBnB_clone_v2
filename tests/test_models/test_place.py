...
class TestPlace(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.place.name = "dfsdgfh"
        cls.place.description = "sdfgh!!!!!"
        cls.place.number_rooms = 100
        cls.place.number_bathrooms = 5
        cls.place.max_guest = 652
        cls.place.price_by_night = 52
        cls.place.latitude = 1.0
        cls.place.longitude = 0.0
        cls.place.amenity_ids = ["1324-lksdrftl"]
